...
<main class="py-8 px-4 text-justify">
  ...
  <section class="max-w-3xl mx-auto space-y-8">
    ...
    <article>
      <h2 class="text-3xl font-semibold text-gray-800 text-left">Israeli-Palestinian Conflict</h2>
      <p class="text-lg text-gray-600 mt-2">
    ...
    <!-- Israel's Strategy -->
    <article>
      <h2 class="text-3xl font-semibold text-gray-800 text-left">Israel's Security Strategy</h2>
      <p class="text-lg text-gray-600 mt-2">
    ...
    <article>
      <h2 class="text-3xl font-semibold text-gray-800 text-left">Lebanon, Syria, and Iran: Shifts in Regional Power</h2>
      <p class="text-lg text-gray-600 mt-2">
    ...
    <article>
      <h2 class="text-3xl font-semibold text-gray-800 text-left">Turkey's Strategic Position</h2>
      <p class="text-lg text-gray-600 mt-2">
    ...
    <article>
      <h2 class="text-3xl font-semibold text-gray-800 text-left">Regional Stability and the Role of the International Community</h2>
      <p class="text-lg text-gray-600 mt-2">
    ...
    <!-- Human Dimension and Future Prospects -->
    <article>
      <h2 class="text-3xl font-semibold text-gray-800 text-left">The Human Dimension and Future Prospects</h2>
      <p class="text-lg text-gray-600 mt-2">
